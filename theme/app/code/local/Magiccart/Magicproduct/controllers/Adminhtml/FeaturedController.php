 ...
 * @@Modify Date: 2015-12-19 11:22:43
 * @@Function:
 */
?>
<?php
class Magiccart_Magicproduct_Adminhtml_FeaturedController extends Mage_Adminhtml_Controller_Action
{
	...
	public function indexAction()
	{
		...
		$this->loadLayout()->_setActiveMenu('magicproduct/featuredproduct');
			
		$this->_addContent($this->getLayout()->createBlock('magicproduct/adminhtml_edit'));
	...
	$this->getResponse()->setBody(
            $this->getLayout()->createBlock('magicproduct/adminhtml_edit_grid')->toHtml()
        );
